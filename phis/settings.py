"""
Django settings for phis project.
...
SECRET_KEY = 'django-insecure-$x@d#7ew6b1czjt#4af(-^z9%j#ob2v&-8308x^xks_ndlixbc'
...
WSGI_APPLICATION = 'phis.wsgi.application'
